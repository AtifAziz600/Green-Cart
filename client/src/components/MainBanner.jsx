  ...
  return (
    <div className='relative'>
      ...
      <div className='flex items-center mt-6 font-medium'>
        <Link to={"/products"} className='group flex items-center gap-2 px-7 md:px-9 py-3 bg-emerald-600 hover:bg-emerald-700 transition rounded text-white cursor-pointer '>
        Shop Now
